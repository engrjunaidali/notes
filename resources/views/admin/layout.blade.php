...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset('admin/assets/img/apple-icon.png')}}" rel="stylesheet">
  <link rel="icon" type="image/png" href="{{asset('admin/assets/img/favicon.png')}}" rel="stylesheet">
  <title>
    Notes App
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{asset('https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html')}}" target="_blank">
        <img src="{{asset('admin/assets/img/logo-ct.png')}}"class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Notes App</span>
      </a>
    </div>
